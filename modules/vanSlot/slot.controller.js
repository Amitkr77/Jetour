...
exports.getAvailableSlots = async (req, res) => {
  try {
    ...
    console.log("Diff days:", selectedDate.diff(today, "day"));
    console.log("Max allowed:", config.max_advance_booking_days);
    ...
    console.log("Operating config:", config.operating_days);
    ...
    console.log("Package worktime:", packageData.worktime);
    console.log("Buffer:", config.buffer_between_bookings_minutes);
    console.log("Slot interval:", config.slot_interval_minutes);
    ...
    console.log("Slots required:", slotsRequired);
    console.log("AvailableTimesMap:", availableTimesMap);
